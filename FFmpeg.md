...
For basic encoding, use this command:

	ffmpeg -i input.mkv -vf scale=-1:480 -ss 0 -t 300 -c:v libx264 -crf 25 -c:a aac -b:a 128k -max_muxing_queue_size 1024 output.mp4
